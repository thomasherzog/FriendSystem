package ch.batthomas.friends.util;
...
public class ConfigHelper {
    ...
    public ConfigHelper(String name, Friends plugin) throws IOException {
        this.name = name;
        this.plugin = plugin;
        createConfig();
    }

    public ConfigHelper(String name, String preset, Friends plugin) throws IOException {
        this.name = name;
        this.plugin = plugin;
        createConfig(preset);
    }
